...
get_ipython().system(' wget https://s3.amazonaws.com/video.udacity-data.com/topher/2019/March/5c88a3f1_household-electric-power-consumption/household-electric-power-consumption.zip')
get_ipython().system(' unzip household-electric-power-consumption')
...
# # use data_range instead of DatetimeIndex
...
get_ipython().run_cell_magic('time', '', '# train and test channels\ndata_channels = {\n    "train": train_path,\n    "test": test_path\n}\n\n# fit the estimator\nestimator.fit(inputs=data_channels)')

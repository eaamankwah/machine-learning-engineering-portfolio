...
get_ipython().system('pygmentize source/model.py')
...
get_ipython().system('pygmentize source/train.py')
...
get_ipython().run_cell_magic('time', '', "# train the estimator on S3 training data\nestimator.fit({'train': input_data})")
...
get_ipython().run_cell_magic('time', '', "# importing PyTorchModel\nfrom sagemaker.pytorch import PyTorchModel\n\n# Create a model from the trained estimator data\n# And point to the prediction script\n# model = None\n# solution\n\nmodel = PyTorchModel(model_data=estimator.model_data,\n                     role = role,\n                     framework_version='1.4',\n                     entry_point='predict.py',\n                     source_dir='source')")
